...
import { evaluateCompliment } from "@/services/compliment.service";
import { evaluateComplimentSchema } from "@/lib/validations/compliment.schema";
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const result = await evaluateCompliment(
