...
import { reevaluateCompliment } from "@/services/compliment.service";
import { reevaluateComplimentSchema } from "@/lib/validations/compliment.schema";
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const result = await reevaluateCompliment(
